...
const SidebarHeader = () => {
  return (
    <div className="flex items-center space-x-2">
      <Image
        src="https://res.cloudinary.com/dsut2iusn/image/upload/v1758796859/my_profile_pics_s9p3uw.png"
        alt="Avatar"
        height="40"
        width="40"
        className="object-cover object-top rounded-full flex-shrink-0"
      />
      <div className="flex text-sm flex-col pt-4">
        <p className="font-bold text-primary">Aduragbemi Soladoye</p>
